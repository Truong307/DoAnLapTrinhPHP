                        ...
                        <div class="title_right">
                            <div class="col-md-5 col-sm-5   form-group pull-right top_search">
                                <div class="input-group">
                                    <form class="d-flex tm-search-form" action="{{ route('admin-tim-kiem') }}">
                                        <input type="text" class="form-control" name="tim_kiem" placeholder="Tìm kiếm...">
                                        <span class="input-group-btn">
                                            <button style="display: block;" class="btn btn-secondary" type="submit">Tìm</button>
                                        </span>
                                    </form>
                                </div>
                            </div>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Mất đồ</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Nhặt đồ</a>
                                            </li>
                                        </ul>
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a>{{ $data->tieu_de }}</a>
                                                                    <br />
                                                                    <small>{{ $data->thoi_gian }}</small>
                                                                </td>
                                                                <td>
                                                                    <a><?php

                                                                        foreach ($lsUser as $nguoidung) {
                                                                            if ($nguoidung->id == $data->nguoi_dung_id) {
                                                                                echo $nguoidung->ten;
                                                                            }
                                                                        }
                                                                ...
                                                                <td>
                                                                    <a><?php
                                                                        foreach ($lsLoaiDoVat as $loaiDoVat)
                                                                            if ($loaiDoVat->id == $data->loai_do_vat_id) {
                                                                                echo $loaiDoVat->ten;
                                                                            }
                                                                        ?></a>
                                                                </td>
                                                                <td>
                                                                    <button type=" button" class="btn btn-success btn-xs">Duyệt</button>
                                                                </td>
                                                                <td>
                                                                    <a href="{{ route('admin-chi-tiet-bai-dang',['id' => $data->id]) }}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Xem chi tiết </a>
