                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a>{{ $data->BaiDang->tieu_de }}</a>
                                                    </td>
                                                    <td>
                                                        <a>{{ $data->NguoiDung->ten }}</a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin-chi-tiet-bai-dang',['id' => $data->bai_dang_id]) }}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Xem chi tiết </a>
                                                        <form action="{{ route('admin-xoa-bai-dang',['id1' => $data->bai_dang_id, 'id2' => $data->id]) }}" method="post">
                                                        @csrf
