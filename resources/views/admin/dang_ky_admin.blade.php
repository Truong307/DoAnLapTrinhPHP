                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-edit"></i> Quản lý quản trị viên <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                ...
                                <li><a><i class="fa fa-desktop"></i> Quản lý người dùng <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form action="{{ route('admin-xl-dang-ky') }}" method="POST">
                                        @csrf
                                        <p>Hãy đảm bảo điền đầy đủ các thông tin của một <code>Quản trị viên</code>
                                        </p>
                                        <span class="section">Thông tin cá nhân</span>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Họ và tên<span class="required"><code>*</code></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="ten" placeholder="VD: Nguyễn Văn A" required="required" />
                                            </div>
                                        </div>

                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">email<span class="required"><code>*</code></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" name="email" class='email' required="required" type="email" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Xác nhận email<span class="required"><code>*</code></span></label>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Tên đăng nhập<span class="required"><code>*</code></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" name="ten_dang_nhap" placeholder="" required="required" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Mật khẩu<span class="required"><code>*</code></span></label>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Nhập lại mật khẩu<span class="required"><code>*</code></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="password" name="password2" data-validate-linked='mat_khau' required='required' />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Số điện thoại<span class="required"><code>*</code></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="tel" class='tel' name="so_dien_thoai" required='required' data-validate-length-range="10" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Địa chỉ<span class="required"><code>*</code></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <textarea required="required" name='dia_chi'></textarea>
                                            </div>
                                        </div>
                                        <div class="ln_solid">
