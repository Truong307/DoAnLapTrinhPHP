                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Chỉnh sửa hồ sơ <code>Quản trị viên</code> </h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form action="{{ route('admin-xl-chinh-sua-ho-so') }}" method="POST">
                                        @csrf
                                        </p>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="ten" value='{{Auth::user()->ten}}' />
                                            </div>
                                        </div>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" name="email" class='email' value='{{Auth::user()->email}}' type="email" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Số điện thoại<span class="required"><code>*</code></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="tel" class='tel' name="so_dien_thoai" value='{{Auth::user()->so_dien_thoai}}'  data-validate-length-range="10" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Địa chỉ<span class="required"><code>*</code></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <textarea  name='dia_chi'>{{Auth::user()->dia_chi}}</textarea>
                                            </div>
                                        </div>
                                        <div class="ln_solid">
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                    ...
                                                    <button type='submit' class="btn btn-primary" value="{{route('admin-ho-so')}}">
                                                        Quay lại</button>
                                                </div>
                                            </div>
                                        </div>
