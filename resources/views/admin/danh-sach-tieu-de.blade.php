                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php $day = date_create($data->thoi_gian);
                                                        echo date_format($day, 'H:i d/m/Y '); ?>

                                                    </td>

                                                    <td>
                                                        <a href="{{ route('admin-chi-tiet-bai-dang',['id' => $data->id]) }}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Xem chi tiết </a>
                                                        <a class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Xóa </a>
